...
export function background2(dimensions: Dimensions, baseColour: number, baseAngle: number = 0) {
  ...
  drawRadial(center, 1200, 130 + baseColour, baseAngle);
  drawRadial(center, 1300, 140 + baseColour, baseAngle + (Math.PI / 6));
  drawRadial(center, 1400, 150 + baseColour, baseAngle);
}
